<?php
// Tietokanta
$user = 'kallionkierros';        //Käytäjänimi 
$pass = 'kallio3210';        //Salasana
$host = 'localhost';  //Tietokantapalvelin
$dbname = 'kallionkierros';        //Tietokanta
...
function login($user, $pwd, $DBH) {
    ...
    try {
        //print_r($data);
        //echo "Login 1<br />";
        $STH = $DBH->prepare("SELECT * FROM A_Kayttaja WHERE Nimimerkki=:kayttaja AND
        Salasana = :passu");
